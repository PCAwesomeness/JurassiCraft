...
/**
 * ModelJoint.java
 * This is an extension of ModelRenderer that creates two cultivate parts: a virtual cultivate and the real cultivate.
 * The real cultivate is a child of the virtual cultivate, and by doing this, one can create better rotations
 * that do not have to only be based off of the real cultivate.
 *
