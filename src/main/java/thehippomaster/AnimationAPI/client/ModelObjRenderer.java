 ...
 * if the modder wants to replace a previous ModelRenderer with a custom cultivate piece without having to redo all of the
 * translations, scales, and rotations. However, this cultivate renders the methods addBox, setTextureOffset, etc useless, as it
