...
public class RenderEntityBlock
{
    ...
    {
        renderBlock(info, blockAccess, x, y, z, x, y, z, doLight);
    }

    public void renderBlock(RenderInfo info, IBlockAccess blockAccess, double x, double y, double z, int lightX, int lightY, int lightZ, boolean doLight)
    {
        ...
        if (realDoLight)
        {
            ...
            int brightness;
            if (info.brightness < 0) brightness = info.baseBlock.getMixedBrightnessForBlock(blockAccess, lightX, lightY, lightZ);
