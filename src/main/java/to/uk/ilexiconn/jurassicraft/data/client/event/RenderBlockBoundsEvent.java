package to.uk.ilexiconn.jurassicraft.data.client.event;
...
public class RenderBlockBoundsEvent
{
    ...
    @SubscribeEvent
    public void onBlockHightlight(DrawBlockHighlightEvent e)
    {
        if (e.target.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
        {
            ...
            {
                AxisAlignedBB[] bounds = ((IBlockHighlight) block).getBoxes(e.player.worldObj, x, y, z, e.player);
